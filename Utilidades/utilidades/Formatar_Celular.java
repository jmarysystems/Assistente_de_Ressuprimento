 ...
 * @author pc
 */
public class Formatar_Celular {
            
    ///////////////////////////////////////////////////////////////////////////
    private JFormattedTextField ftm;
    private boolean             b;
    private String              txtftm;
    public Formatar_Celular( JFormattedTextField ftm2, String x2, boolean b2 ){ ftm = ftm2; b = b2; txtftm = x2;
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            // setarFocusLost
            else{  if( txtftm.length() < 24 ){ ftm.setText( "" ); } }
