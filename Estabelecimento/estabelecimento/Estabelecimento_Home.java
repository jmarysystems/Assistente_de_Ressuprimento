 ...
 * @author pc
 */
public class Estabelecimento_Home extends javax.swing.JPanel {

    public Home                                   Home;
    public JTabbedPane                            tabHome;
    
    public Estabelecimento_Home_Inicio       Inicio;
            
    /**
     * Creates new form Fonema_E_Letra_Home
     * @param Home2
     */
    public Estabelecimento_Home( Home Home2 ) {
        initComponents();
        
        Home                       = Home2;
        tabHome                    = new JTabbedPane();
                                        
        Inicio = new Estabelecimento_Home_Inicio( this );
                
    }
    
    //////////////////////////////////////////////////////    
    public Estabelecimento_Home( Home Home2, JTabbedPane tabHome2 ) {
        initComponents();
        
        Home                       = Home2;
        tabHome                    = tabHome2;
                                
        Inicio = new Estabelecimento_Home_Inicio( this, tabHome );
    ...
    public Estabelecimento_Home( Home Home2, Controle_Acesso_New Controle_Acesso_New2 ) {
        initComponents();
        ...
        Inicio = new Estabelecimento_Home_Inicio( this, Controle_Acesso_New2 );
