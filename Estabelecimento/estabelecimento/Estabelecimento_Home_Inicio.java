...
import estabelecimento_search.Menu_Pesquisa_Estabelecimento;
import estabelecimento_search.Tabela_Pesquisa_BD_Estabelecimento;
 ...
 * @author pc
 */
public class Estabelecimento_Home_Inicio {
        
    Conjunto_Botoes       Conjunto_Botoes;
    Estabelecimento_Home  Estabelecimento_Home;//Materias_Home; 
    
    public Estabelecimento_Home_Inicio( Estabelecimento_Home Embalagem_Home2 ) {
    ...
    //////////////////////////////////////////////////////
    public Estabelecimento_Home_Inicio( Estabelecimento_Home Estabelecimento_Home2, JTabbedPane tabHome2 ) {
        ...
        try { Thread.sleep( 1 ); 
            ...
            //////////////////
            Menu_Pesquisa_Estabelecimento      Menu_Pesquisa                      = new Menu_Pesquisa_Estabelecimento( Estabelecimento_Home, tabHome2 );
            Tabela_Pesquisa_BD_Estabelecimento Tabela_Pesquisa_BD_Estabelecimento = new Tabela_Pesquisa_BD_Estabelecimento( Estabelecimento_Home );
    ...
    //////////////////////////////////////////////////////
    public Estabelecimento_Home_Inicio( Estabelecimento_Home Estabelecimento_Home2, Controle_Acesso_New Controle_Acesso_New2 ) {
        ...
        try { Thread.sleep( 1 ); 
            ...
            //////////////////
            Menu_Pesquisa_Estabelecimento      Menu_Pesquisa                      = new Menu_Pesquisa_Estabelecimento( Estabelecimento_Home, Estabelecimento_Home.Controle_Acesso_New );
            Tabela_Pesquisa_BD_Estabelecimento Tabela_Pesquisa_BD_Estabelecimento = new Tabela_Pesquisa_BD_Estabelecimento( Estabelecimento_Home );
    ...
    public void addAbaNovo(){      
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            Estabelecimento_Home.Home.ControleTabs.AddTabSemControleNovo(Estabelecimento_Home.tabHome, "Novo", "/utilidades_imagens/novo.gif", new Estabelecimento_New(Estabelecimento_Home) );
    ...
    public void addAbaPesquisa(){        
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            Menu_Pesquisa_Estabelecimento Menu_Pesquisa           = new Menu_Pesquisa_Estabelecimento( Estabelecimento_Home );
            Tabela_Pesquisa_BD_Estabelecimento Tabela_Pesquisa_BD = new Tabela_Pesquisa_BD_Estabelecimento( Estabelecimento_Home );
