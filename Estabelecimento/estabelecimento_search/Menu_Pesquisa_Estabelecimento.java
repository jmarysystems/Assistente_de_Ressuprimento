 ...
 * @author AnaMariana
 */
public class Menu_Pesquisa_Estabelecimento extends javax.swing.JPanel {

    Estabelecimento_Home  Estabelecimento_Home;
    public  int    IDSELECIONADA; 
    public Tabela_Pesquisa_BD_Estabelecimento Tabela_Pesquisa_BD_Estabelecimento;
     
    /**
     * Creates new form Cliente
     * @param Estabelecimento_Home2
     */
    public Menu_Pesquisa_Estabelecimento( Estabelecimento_Home Estabelecimento_Home2 ) {
        initComponents();
    ...
    public Menu_Pesquisa_Estabelecimento( Estabelecimento_Home Estabelecimento_Home2, JTabbedPane tabHome ) {
        initComponents();
                    ...
                    ////////////////////////////
                     if( btSelecionar.isEnabled() ) {            
                         if( IDSELECIONADA > 0 ) {
                             ...
                             Query q = JPAUtil.em().createNativeQuery( "SELECT * FROM SCHEMAJMARY.ESTABELECIMENTO WHERE ID = ?", Estabelecimento.class );
                             ...
                             String str = Estabelecimento.getNomeFantasia();
                             //Venda_Home Venda_Home = new Venda_Home( Estabelecimento_Home.Home, Estabelecimento_Home.tabHome, Estabelecimento );
                             
                             //Estabelecimento_Home.Home.ControleTabs.removerTabSemControleSelecionado( Estabelecimento_Home.tabHome );
                             try { Thread.sleep( 3 ); 
                             
                                 //Estabelecimento_Home.Home.ControleTabs.AddTabSemControleNovo( Estabelecimento_Home.tabHome, str, "/utilidades_imagens/novo.gif", Venda_Home );
    ...
    ////Menu_Pesquisa_Gestor2//////////////////////////////////////////////////////////////////
    public Menu_Pesquisa_Estabelecimento( Estabelecimento_Home Estabelecimento_Home2, Controle_Acesso_New Controle_Acesso_New2 ) {
        initComponents();
                    ...
                    ////////////////////////////
                     if( btSelecionar.isEnabled() ) {            
                         if( IDSELECIONADA > 0 ) {
                             ...
                             Estabelecimento_Home.Controle_Acesso_New.setarNoJPanelEstabelecimentoSelecionado( Estabelecimento );
    ...
    public void tabela(Tabela_Pesquisa_BD_Estabelecimento Tabela_Pesquisa_BD_Estabelecimento2 ){ 
    ...
    private void pesquisar() {       
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            Query q = JPAUtil.em().createNativeQuery( "SELECT * FROM SCHEMAJMARY.ESTABELECIMENTO WHERE RAZAO_SOCIAL LIKE ?", estabelecimento.Estabelecimento.class );
            if( !tf.equals("") ){
            ...
            if(listestabelecimentoX != null) { Tabela_Pesquisa_BD_Estabelecimento.mostrarLista( listestabelecimentoX ); }
            */
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            if( btExcluir.isEnabled() ) {
                ...
                if( IDSELECIONADA > 0 ) {
                    ...
                    //////////////////////////////////////////////////////////////////////////////////////////
                    estabelecimento.Estabelecimento Estabelecimento = new estabelecimento.Estabelecimento();
                    
                    Query q = JPAUtil.em().createNativeQuery( "SELECT * FROM SCHEMAJMARY.ESTABELECIMENTO WHERE ID = ?", estabelecimento.Estabelecimento.class );
                    q.setParameter(1, IDSELECIONADA);   
        ...
        try {                       
                if( IDSELECIONADA > 0 ) {
                    ...
                    if( str.equals( "Visualizar") ){
                        ...
                        Estabelecimento_New New = new Estabelecimento_New( Estabelecimento_Home, Estabelecimento );
