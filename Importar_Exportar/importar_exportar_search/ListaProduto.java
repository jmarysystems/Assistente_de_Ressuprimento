...
public class ListaProduto extends javax.swing.JFrame {
     ...
     * @param tbPesquisa2
     */
    public ListaProduto( Menu_Pesquisa_Importar_Exportar Menu_Pesquisa_Importar_Exportar2, JTable tbPesquisa2 ) { 
        initComponents();
                        ...
                        try { Thread.sleep( 1 );
                            ...
                            if( !str.equals("") ){
                                ...
                                //for(String nome:str){ 
                                    ...
                                    tmPesquisa.addRow(new Object[]{ t0, t1, t2 });
    ...
    private void initComponents() {
        ...
        jLabel4.setText("COLE AQUI: SAP - UND - DESCRIÇÃO ");
