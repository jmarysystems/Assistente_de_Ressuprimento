 ...
 * @author AnaMariana
 */
public class ListaData extends javax.swing.JFrame {
     ...
     * @param tbPesquisa2
     */
    public ListaData( Menu_Pesquisa_Importar_Exportar Menu_Pesquisa_Importar_Exportar2, JTable tbPesquisa2 ) { 
        initComponents();
                        ...
                        try { Thread.sleep( 1 );
                            ...
                            if( !str.equals("") ){
                                ...
                                //for(String nome:str){ 
                                    ...
                                    cuntP = 0;
                                    tmPesquisa.addRow(new Object[]{ t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t10 });
    ...
    private void initComponents() {
        ...
        jLabel4.setText("COLE AQUI: SAP - DATA INÍCIO - DATA FIM");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
