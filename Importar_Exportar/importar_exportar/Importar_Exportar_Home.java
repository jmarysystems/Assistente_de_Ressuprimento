 ...
 * @author pc
 */
public class Importar_Exportar_Home extends javax.swing.JPanel {

    public Home                                   Home;
    public JTabbedPane                            tabHome;
    
    public Importar_Exportar_Home_Inicio       Inicio;
            
    /**
     * Creates new form Fonema_E_Letra_Home
     * @param Home2
     */
    public Importar_Exportar_Home( Home Home2 ) {
        initComponents();
        
        Home                       = Home2;
        tabHome                    = new JTabbedPane();
                                        
        Inicio = new Importar_Exportar_Home_Inicio( this );
                
    }
    
    //////////////////////////////////////////////////////    
    public Importar_Exportar_Home( Home Home2, JTabbedPane tabHome2 ) {
        initComponents();
        
        Home                       = Home2;
        tabHome                    = tabHome2;
                                
        Inicio = new Importar_Exportar_Home_Inicio( this, tabHome );
                
    }
    //////////////////////////////////////////////////////
    
    //////////////////////////////////////////////////////
    public Controle_Acesso_New Controle_Acesso_New;
    
    public Importar_Exportar_Home( Home Home2, Controle_Acesso_New Controle_Acesso_New2 ) {
        initComponents();
        
        Home                       = Home2;
        tabHome                    = new JTabbedPane();
        
        Controle_Acesso_New        = Controle_Acesso_New2;
                                
        Inicio = new Importar_Exportar_Home_Inicio( this, Controle_Acesso_New2 );
