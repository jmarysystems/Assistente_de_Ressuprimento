...
public class LoginDerby extends javax.swing.JFrame {
        ...
        for (int i = 0; i < List_Bean_Login.size(); i++){ 
            ...
            if( List_Bean_Login.get(i).getLOGIN().equals( login ) ) {
                ...
                if( passwordCorreto( senha, List_Bean_Login.get(i).getSENHA() ) ) { 
                    ...
                    q.setParameter(1, List_Bean_Login.get(i).getID());   
                    ...
                    //////////////////////////////////////////////////////////////////////////////////////////
                    if( Usuario.getPermitiracesso() == true ){
    ...
    private void sem1( String usr ) {
       JOPM JOptionPaneMod = new JOPM( 2, "USUÁRIO SEM PERMISSÃO DE ACESSO, "
                        + "\nO Usuário " + usr + " "
                        + "\nNão tem permissão de acesso ao sistema"
                        + "\n"
