 ...
 * @author AnaMariana
 */
public class Menu_Pesquisa_Pais extends javax.swing.JPanel {

    Pais_Home  Estabelecimento_Home;
    public  int    IDSELECIONADA; 
    public Tabela_Pesquisa_BD_Pais Tabela_Pesquisa_BD_Estabelecimento;
     
    /**
     * Creates new form Cliente
     * @param Estabelecimento_Home2
     */
    public Menu_Pesquisa_Pais( Pais_Home Estabelecimento_Home2 ) {
        initComponents();
    ...
    public Menu_Pesquisa_Pais( Pais_Home Estabelecimento_Home2, JTabbedPane tabHome ) {
        initComponents();
                    ...
                    ////////////////////////////
                     if( btSelecionar.isEnabled() ) {            
                         if( IDSELECIONADA > 0 ) {
                             ...
                             Pais Estabelecimento = new Pais();

                             Query q = JPAUtil.em().createNativeQuery("SELECT * FROM SCHEMAJMARY.PAIS WHERE ID = ?", Pais.class );
                             ...
                             //Venda_Home Venda_Home = new Venda_Home( Pais_Home.Home, Pais_Home.tabHome, Pais );
                             
                             //Estabelecimento_Home.Home.ControleTabs.removerTabSemControleSelecionado( Pais_Home.tabHome );
                             try { Thread.sleep( 3 ); 
                             
                                 //Estabelecimento_Home.Home.ControleTabs.AddTabSemControleNovo( Pais_Home.tabHome, str, "/utilidades_imagens/novo.gif", Venda_Home );
    ...
    public void tabela(Tabela_Pesquisa_BD_Pais Tabela_Pesquisa_BD_Estabelecimento2 ){ 
    ...
    private void pesquisar() {       
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            Query q = JPAUtil.em().createNativeQuery("SELECT * FROM SCHEMAJMARY.PAIS WHERE NOME_PTBR LIKE ?", pais_0.Pais.class );
            if( !tf.equals("") ){
            ...
            /*
            Pais EstabelecimentoX = new Pais();
            ...
            if(listestabelecimentoX != null) { Tabela_Pesquisa_BD_Pais.mostrarLista( listestabelecimentoX ); }
            */
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            if( btExcluir.isEnabled() ) {
                ...
                if( IDSELECIONADA > 0 ) {
                    ...
                    //////////////////////////////////////////////////////////////////////////////////////////
                    pais_0.Pais Estabelecimento = new pais_0.Pais();
                    
                    Query q = JPAUtil.em().createNativeQuery("SELECT * FROM SCHEMAJMARY.PAIS WHERE ID = ?", pais_0.Pais.class );
                    q.setParameter(1, IDSELECIONADA);   
        ...
        try {                       
                if( IDSELECIONADA > 0 ) {
                    ...
                    if( str.equals( "Visualizar") ){
                        ...
                        Pais_New New = new Pais_New( Estabelecimento_Home, Estabelecimento );
