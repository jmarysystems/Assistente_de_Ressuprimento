...
import pais_new.Pais_New;
import pais_search.Menu_Pesquisa_Pais;
import pais_search.Tabela_Pesquisa_BD_Pais;
 ...
 * @author pc
 */
public class Pais_Home_Inicio {
        
    Conjunto_Botoes       Conjunto_Botoes;
    Pais_Home  Estabelecimento_Home;//Materias_Home; 
    
    public Pais_Home_Inicio( Pais_Home Embalagem_Home2 ) {
    ...
    //////////////////////////////////////////////////////
    public Pais_Home_Inicio( Pais_Home Estabelecimento_Home2, JTabbedPane tabHome2 ) {
        ...
        try { Thread.sleep( 1 ); 
            ...
            //////////////////
            Menu_Pesquisa_Pais      Menu_Pesquisa                      = new Menu_Pesquisa_Pais( Estabelecimento_Home, tabHome2 );
            Tabela_Pesquisa_BD_Pais Tabela_Pesquisa_BD_Estabelecimento = new Tabela_Pesquisa_BD_Pais( Estabelecimento_Home );
    ...
    public void addAbaNovo(){      
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            Estabelecimento_Home.Home.ControleTabs.AddTabSemControleNovo(Estabelecimento_Home.tabHome, "Novo", "/utilidades_imagens/novo.gif", new Pais_New(Estabelecimento_Home) );
    ...
    public void addAbaPesquisa(){        
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            Menu_Pesquisa_Pais Menu_Pesquisa           = new Menu_Pesquisa_Pais( Estabelecimento_Home );
            Tabela_Pesquisa_BD_Pais Tabela_Pesquisa_BD = new Tabela_Pesquisa_BD_Pais( Estabelecimento_Home );
                ...
                @Override
                 public void mousePressed(java.awt.event.MouseEvent evt) {
                     ...
                     new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
                         ...
                         if( Administrador.mapaComandos.get("CADASTRAR_PAIS") != null ) {
                 ...
                 public void mousePressed(java.awt.event.MouseEvent evt) {
                     ...
                     */
                     ...
                     new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
                         ...
                         if( Administrador.mapaComandos.get("PESQUISAR_PAIS") != null ) {
