 ...
 * @author AnaMariana
 */
public class Menu_Pesquisa_Municipio extends javax.swing.JPanel {

    Municipio_Home  Uf_Home;
    public  int    IDSELECIONADA; 
    public Tabela_Pesquisa_BD_Municipio Tabela_Pesquisa_BD_Uf;
     
    /**
     * Creates new form Cliente
     * @param Estabelecimento_Home2
     */
    public Menu_Pesquisa_Municipio( Municipio_Home Estabelecimento_Home2 ) {
        initComponents();
    ...
    public Menu_Pesquisa_Municipio( Municipio_Home Estabelecimento_Home2, JTabbedPane tabHome ) {
        initComponents();
                    ...
                    ////////////////////////////
                     if( btSelecionar.isEnabled() ) {            
                         if( IDSELECIONADA > 0 ) {
                             ...
                             Query q = JPAUtil.em().createNativeQuery("SELECT * FROM SCHEMAJMARY.MUNICIPIO WHERE ID = ?", Municipio.class );
                             ...
                             //String str = Municipio.getNomeFantasia();
                             //Venda_Home Venda_Home = new Venda_Home( Municipio_Home.Home, Municipio_Home.tabHome, Municipio );
                             
                             //Estabelecimento_Home.Home.ControleTabs.removerTabSemControleSelecionado( Municipio_Home.tabHome );
                             try { Thread.sleep( 3 ); 
                             
                                 //Estabelecimento_Home.Home.ControleTabs.AddTabSemControleNovo( Municipio_Home.tabHome, str, "/utilidades_imagens/novo.gif", Venda_Home );
    ...
    public void tabela(Tabela_Pesquisa_BD_Municipio Tabela_Pesquisa_BD_Estabelecimento2 ){ 
    ...
    private void pesquisar() {       
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            Query q = JPAUtil.em().createNativeQuery("SELECT * FROM SCHEMAJMARY.MUNICIPIO WHERE NOME LIKE ?", municipio.Municipio.class );
            if( !tf.equals("") ){
            ...
            /*
            Municipio EstabelecimentoX = new Municipio();
            ...
            if(listestabelecimentoX != null) { Tabela_Pesquisa_BD_Municipio.mostrarLista( listestabelecimentoX ); }
            */
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            if( btExcluir.isEnabled() ) {
                ...
                if( IDSELECIONADA > 0 ) {
                    ...
                    //////////////////////////////////////////////////////////////////////////////////////////
                    municipio.Municipio Municipio = new municipio.Municipio();
                    
                    Query q = JPAUtil.em().createNativeQuery("SELECT * FROM SCHEMAJMARY.MUNICIPIO WHERE ID = ?", municipio.Municipio.class );
                    q.setParameter(1, IDSELECIONADA);   
    ...
    private void alterarOuVisualizar(String str) {
        try {                       
                if( IDSELECIONADA > 0 ) {
                    ...
                    municipio.Municipio Estabelecimento = new municipio.Municipio();
                    ...
                    if( str.equals( "Visualizar") ){
                        ...
                        Municipio_New New = new Municipio_New( Uf_Home, Estabelecimento );
                        Uf_Home.Home.ControleTabs.AddTabSemControleNovo(Uf_Home.tabHome, "Visualizar", "/utilidades_imagens/olho.png", New );
                        ...
                        Municipio_New New = new Municipio_New( Uf_Home, Estabelecimento );
                        Uf_Home.Home.ControleTabs.AddTabSemControleNovo(Uf_Home.tabHome, "Alterar", "/utilidades_imagens/alterar.gif", New );
                    }
                }
                else{
                    JOPM JOptionPaneMod = new JOPM( 2, "ID SELECIONADA, "
