 ...
 * @author AnaMariana
 */
public class Menu_Pesquisa_Acesso extends javax.swing.JPanel {

    Acesso_Home  Acesso_Home;
    public  int    IDSELECIONADA; 
    public Tabela_Pesquisa_BD_Acesso Tabela_Pesquisa_BD_Estabelecimento;
     
    /**
     * Creates new form Cliente
     * @param Estabelecimento_Home2
     */
    public Menu_Pesquisa_Acesso( Acesso_Home Estabelecimento_Home2 ) {
        initComponents();
    ...
    public Menu_Pesquisa_Acesso( Acesso_Home Estabelecimento_Home2, JTabbedPane tabHome ) {
        initComponents();
                    ...
                    ////////////////////////////
                     if( btSelecionar.isEnabled() ) {            
                         if( IDSELECIONADA > 0 ) {
                             ...
                             Query q = JPAUtil.em().createNativeQuery("SELECT * FROM SCHEMAJMARY.ACESSO WHERE ID = ?", Acesso.class );
                             ...
                             String str = Acesso.getComandodoacesso();
                             //Venda_Home Venda_Home = new Venda_Home( Acesso_Home.Home, Acesso_Home.tabHome, Acesso );
                             
                             //Estabelecimento_Home.Home.ControleTabs.removerTabSemControleSelecionado( Acesso_Home.tabHome );
                             try { Thread.sleep( 3 ); 
                             
                                 //Estabelecimento_Home.Home.ControleTabs.AddTabSemControleNovo( Acesso_Home.tabHome, str, "/utilidades_imagens/novo.gif", Venda_Home );
    ...
    ////Menu_Pesquisa_Gestor2//////////////////////////////////////////////////////////////////
    public Menu_Pesquisa_Acesso( Acesso_Home Acesso_Home2, Controle_Acesso_New Controle_Acesso_New2 ) {
        initComponents();
                    ...
                    ////////////////////////////
                     if( btSelecionar.isEnabled() ) {            
                         if( IDSELECIONADA > 0 ) {
                             ...
                             Acesso_Home.Controle_Acesso_New.setarNoJPanelAcessoSelecionado( Acesso );
    ...
    public void tabela(Tabela_Pesquisa_BD_Acesso Tabela_Pesquisa_BD_Estabelecimento2 ){ 
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Dados do Comando");
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(rbNome, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void pesquisar() {       
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            Query q = JPAUtil.em().createNativeQuery("SELECT * FROM SCHEMAJMARY.ACESSO WHERE COMANDODOACESSO LIKE ?", acesso.Acesso.class );
            if( !tf.equals("") ){
            ...
            if(q != null) { Tabela_Pesquisa_BD_Estabelecimento.pesquisa(q); }
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            if( btExcluir.isEnabled() ) {
                ...
                if( IDSELECIONADA > 0 ) {
                    ...
                    //////////////////////////////////////////////////////////////////////////////////////////
                    acesso.Acesso Estabelecimento = new acesso.Acesso();
                    
                    Query q = JPAUtil.em().createNativeQuery("SELECT * FROM SCHEMAJMARY.ACESSO WHERE ID = ?", acesso.Acesso.class );
                    q.setParameter(1, IDSELECIONADA);   
        ...
        try {                       
                if( IDSELECIONADA > 0 ) {
                    ...
                    if( str.equals( "Visualizar") ){
                        ...
                        Acesso_New New = new Acesso_New( Acesso_Home, Estabelecimento );
                        Acesso_Home.Home.ControleTabs.AddTabSemControleNovo(Acesso_Home.tabHome, "Visualizar", "/utilidades_imagens/olho.png", New );
                        ...
                        Acesso_New New = new Acesso_New( Acesso_Home, Estabelecimento );
                        Acesso_Home.Home.ControleTabs.AddTabSemControleNovo(Acesso_Home.tabHome, "Alterar", "/utilidades_imagens/alterar.gif", New );
                    }
                }
                else{
                    JOPM JOptionPaneMod = new JOPM( 2, "ID SELECIONADA, "
