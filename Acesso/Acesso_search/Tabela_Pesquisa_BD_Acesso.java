 ...
 * @author ana
 */
public class Tabela_Pesquisa_BD_Acesso extends javax.swing.JPanel {
   
    private Acesso_Home          Acesso_Home;
    private Menu_Pesquisa_Acesso Menu_Pesquisa;
        
    private List<acesso.Acesso> list;
    private ListSelectionModel               lsmPesquisa;
    private final DefaultTableModel          tmPesquisa = new DefaultTableModel( null, new String[]{ "     ID","COMANDO", "DESCRIÇÃO", "CADASTRADO POR", "DATA CADASTRO" } );
    
    public Tabela_Pesquisa_BD_Acesso( Acesso_Home Estabelecimento_Home2 ) {
    ...
    public void tabela(Menu_Pesquisa_Acesso Menu_Pesquisa2){ 
    ...
    private void tbPreferedSize(){        
        try{
            ...
            tbPesquisa.getColumnModel().getColumn(1).setPreferredWidth(210);
    ...
    public void mostrarLista( List<acesso.Acesso> listR ){  try {                    
            ...
            if ( listR.isEmpty() ){ //JOptionPane.showMessageDialog( null , "Nenhum dado encontrado!"); 
                ...
                for (int i = 0; i < listR.size(); i++){
                    ...
                    tmPesquisa.setValueAt( listR.get(i).getComandodoacesso()     , i, 1);
                    tmPesquisa.setValueAt( listR.get(i).getDescricaodoacesso()   , i, 2);
    ...
    private void tbPesquisaLinhaSelecionada() { 
        try{
            ...
            if ( tbPesquisa.getSelectedRow() != -1){
                ...
                if( Administrador.mapaComandos.get("ALTERAR_ACESSO") != null ) {
                    Menu_Pesquisa.btAlterar.setEnabled(true);
                }  
                
                if( Administrador.mapaComandos.get("EXCLUIR_ACESSO") != null ) {
