 ...
 * @author AnaMariana
 */
public class Menu_Pesquisa_Uf extends javax.swing.JPanel {

    Uf_Home  Uf_Home;
    public  int    IDSELECIONADA; 
    public Tabela_Pesquisa_BD_Uf Tabela_Pesquisa_BD_Uf;
     
    /**
     * Creates new form Cliente
     * @param Estabelecimento_Home2
     */
    public Menu_Pesquisa_Uf( Uf_Home Estabelecimento_Home2 ) {
        initComponents();
    ...
    public Menu_Pesquisa_Uf( Uf_Home Estabelecimento_Home2, JTabbedPane tabHome ) {
        initComponents();
                    ...
                    ////////////////////////////
                     if( btSelecionar.isEnabled() ) {            
                         if( IDSELECIONADA > 0 ) {
                             ...
                             Uf Estabelecimento = new Uf();

                             Query q = JPAUtil.em().createNativeQuery("SELECT * FROM SCHEMAJMARY.UF WHERE ID = ?", Uf.class );
                             ...
                             //Venda_Home Venda_Home = new Venda_Home( Uf_Home.Home, Uf_Home.tabHome, Uf );
                             
                             //Estabelecimento_Home.Home.ControleTabs.removerTabSemControleSelecionado( Uf_Home.tabHome );
                             try { Thread.sleep( 3 ); 
                             
                                 //Estabelecimento_Home.Home.ControleTabs.AddTabSemControleNovo( Uf_Home.tabHome, str, "/utilidades_imagens/novo.gif", Venda_Home );
    ...
    public void tabela(Tabela_Pesquisa_BD_Uf Tabela_Pesquisa_BD_Estabelecimento2 ){ 
    ...
    private void pesquisar() {       
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            Query q = JPAUtil.em().createNativeQuery("SELECT * FROM SCHEMAJMARY.UF WHERE NOME LIKE ?", uf_0.Uf.class );
            if( !tf.equals("") ){
            ...
            if(listestabelecimentoX != null) { Tabela_Pesquisa_BD_Uf.mostrarLista( listestabelecimentoX ); }
            */
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            if( btExcluir.isEnabled() ) {
                ...
                if( IDSELECIONADA > 0 ) {
                    ...
                    //////////////////////////////////////////////////////////////////////////////////////////
                    uf_0.Uf Estabelecimento = new uf_0.Uf();
                    
                    Query q = JPAUtil.em().createNativeQuery("SELECT * FROM SCHEMAJMARY.UF WHERE ID = ?", uf_0.Uf.class );
                    q.setParameter(1, IDSELECIONADA);   
        ...
        try {                       
                if( IDSELECIONADA > 0 ) {
                    ...
                    if( str.equals( "Visualizar") ){
                        ...
                        Uf_New New = new Uf_New( Uf_Home, Estabelecimento );
