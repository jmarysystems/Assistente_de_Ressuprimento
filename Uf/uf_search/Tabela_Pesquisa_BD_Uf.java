 ...
 * @author ana
 */
public class Tabela_Pesquisa_BD_Uf extends javax.swing.JPanel {
   
    private Uf_Home          Estabelecimento_Home;
    private Menu_Pesquisa_Uf Menu_Pesquisa;
        
    private List<uf_0.Uf> list;
    private ListSelectionModel               lsmPesquisa;
    private final DefaultTableModel          tmPesquisa = new DefaultTableModel( null, new String[]{ "     ID","NOME", "CÓDIGO IBGE", "SIGLA", "PAIS", "CADASTRADO POR"} );
    
    public Tabela_Pesquisa_BD_Uf( Uf_Home Estabelecimento_Home2 ) {
    ...
    public void tabela(Menu_Pesquisa_Uf Menu_Pesquisa2){ 
    ...
    public void mostrarLista( List<uf_0.Uf> listR ){  try {                    
            ...
            if ( listR.isEmpty() ){ //JOptionPane.showMessageDialog( null , "Nenhum dado encontrado!"); 
                ...
                for (int i = 0; i < listR.size(); i++){
                    ...
                    tmPesquisa.setValueAt( listR.get(i).getCodigoIbge()         , i, 2);
                    tmPesquisa.setValueAt( listR.get(i).getSigla()              , i, 3);
                    ...
                    try{
                        ...
                        tmPesquisa.setValueAt( Pais_X.getNomePtbr()             , i, 4);
                    } catch( Exception e ){}
    ...
    private void tbPesquisaLinhaSelecionada() { 
        try{
            ...
            if ( tbPesquisa.getSelectedRow() != -1){
                ...
                if( Administrador.mapaComandos.get("ALTERAR_UF") != null ) {
                    Menu_Pesquisa.btAlterar.setEnabled(true);
                }  
                
                if( Administrador.mapaComandos.get("EXCLUIR_UF") != null ) {
